...
void dmaScreenShot(){
	//write to slave regs
	DMACONTROLLER_mWriteSlaveReg0(XPAR_DMACONTROLLER_0_BASEADDR, DMACONTROLLER_SLV_REG0_OFFSET, &framePointer0);
	DMACONTROLLER_mWriteSlaveReg1(XPAR_DMACONTROLLER_0_BASEADDR, DMACONTROLLER_SLV_REG1_OFFSET, &framePointer1);
	DMACONTROLLER_mWriteSlaveReg2(XPAR_DMACONTROLLER_0_BASEADDR, DMACONTROLLER_SLV_REG2_OFFSET, SCREEN_WIDTH * SCREEN_HEIGHT);
